...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, n_actions, name, chkpt_dir='tmp/dppg'):
...
class Agent(object):
    def __init__(self, alpha, beta, input_dims, tau, env, gamma=0.99, n_actions=2, max_size=1_000_000,
    ...
    def learn(self):
        ...
        dones = T.tensor(dones, dtype=T.float).to(self.critic.device)
